...
export default function LoginPage() {
  ...
  const handleGoogle = async () => {
    try {
      ...
      await authClient.signIn.social({ provider: "google", callbackURL: process.env.NEXT_PUBLIC_APP_URL });
    } catch {
    ...
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2">Sign in to your Red Rose account</p>
        </div>
        ...
        <div className="card p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between mb-1.5">
                ...
                <Link href="/auth/forgot-password" className="text-xs text-rose-600 hover:text-rose-800">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <Link href="/auth/register" className="text-rose-600 hover:text-rose-800 font-medium">
              Sign up
            </Link>
          </p>
        </div>
